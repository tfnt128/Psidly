...
export default function NewPatient({messageOk, setMessageOk, setTextMessagePad, setTextBtnMessagePad, setScreenBlur, setSlide}){
    ...
    return(
        <div className="relative bg-quarternario mb-40 lg:mb-0 h-[830px] lg:h-[2300px] mt-40 lg:mt-0 lg:w-[1200px] w-[350px] flex flex-col items-center lg:rounded-[150px] rounded-[30px]">
            {
                standState &&
