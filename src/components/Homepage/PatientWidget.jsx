...
export default function PatientWidget({OnClickFunction, ProfilePhoto, Nome, Idade, Style}){
    return(
        <div className={`w-[80%] lg:max-w-[700px] lg:rounded-[80px] lg:h-[800px] h-[300px] bg-blue-300 rounded-[30px] flex flex-col items-center transition-transform duration-300 hover:scale-105 hover:shadow-[0_0_40px_10px_rgba(59,130,246,0.6)] cursor-pointer ${Style}`}
        onClick={OnClickFunction}>
            ...
            <div className="flex flex-col items-center">
                <h1 className="text-[20px] lg:text-[50px] font-aboreto mt-3 text-blue-900">{Nome}</h1>
                <h1 className="text-[20px] lg:text-[50px] font-aboreto mt-3 text-blue-900">{Idade} anos</h1>
