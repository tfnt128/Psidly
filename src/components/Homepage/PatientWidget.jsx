...
export default function PatientWidget(){
    return(
        <div className="w-[80%] lg:w-[700px] lg:rounded-[80px] lg:h-[700px] h-[300px] bg-blue-300 rounded-[30px] flex flex-col items-center transition-transform duration-300 hover:scale-105 hover:shadow-[0_0_40px_10px_rgba(59,130,246,0.6)] cursor-pointer">
