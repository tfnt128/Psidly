...
import OkayNotf from "../General/OkayNotf";
...
export default function LoginBox({setOkayNotifInfo, setResponseLogin}){
        ...
        try {
            ...
            if (response.success == true){
                ...
                if(response.userType != 'Paciente'){
                    ...
                    localStorage.setItem("insurances", JSON.stringify(response.user.insurances))
                }
    ...
    return(
        <div className={`relative flex flex-col items-center mt-20 bg-terciario rounded-[30px] lg:rounded-[80px] w-[80%] min-w-[80%] h-[880px] lg:h-[1500px]`}>
            {
                standState &&
