...
export default function Profilebox({messageOk, setMessageOk, setTextBtnOk, setTextMessagePad}){
    ...
    return(
        <div className="w-[85%] lg:w-[1700px] h-[730px] lg:h-[2650px] lg:ml-[850px] lg:mt-[3%] mt-[7%] flex flex-col lg:flex-col items-center bg-quarternario rounded-[20px] lg:rounded-[100px]"
        onClick={()=>closeOptions()}>
            ...
            <div className="w-full h-full  mt-2 lg:mt-30 flex flex-col items-center">
                ...
                <div className="w-[100%] flex flex-col items-center gap-5 lg:gap-15">
                        ...
                        <ShowPut setValue={setInsurances} ReadOnly={true}  BorderBg={"border-blue-300"} TextColor={"text-blue-300"} Style={"w-[300px] h-[225px] lg:w-[1400px] lg:h-[1000px] hover:transform hover:scale-110 hover:duration-300"} Bg={bgEdit} Cancel={cancel} Label={t('convenios')} Text={insurances ? insurances.join('\n ') : ""} />
