...
export default function OcultoPage(){
    ...
    return(
        <div className="min-h-screen">
            ...
            <div className="flex flex-col gap-10 mb-[220px] items-center mt-20 lg:grid lg:grid-cols-4 lg:gap-x-0 lg:gap-y-30 lg:gap-1 lg:mt-60 lg:w-[60%]  lg:items-center lg:ml-200">
                {
