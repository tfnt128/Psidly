...
export default function CadastroBox({}){
    return(
        <div className="flex flex-col items-center  bg-terciario rounded-[30px] lg:rounded-[100px] w-[80%] min-w-[80%] h-[700px] lg:h-[2200px] ">
            ...
            <Input Style={"w-[80%] outline-none bg-primario p-[15px] lg:p-[55px] rounded-[15px] lg:rounded-[35px] lg:text-[40px] placeholder:text-[15px] lg:placeholder:text-[45px] placeholder:font-lexenddeca mt-[27px] lg:mt-[60px]"} PlaceHolder={'Insira seu nome'} Type={"text"}/>
            <Input Style={"w-[80%] outline-none bg-primario p-[15px] lg:p-[55px] rounded-[15px] lg:rounded-[35px] lg:text-[40px] placeholder:text-[15px] lg:placeholder:text-[45px] placeholder:font-lexenddeca mt-[27px] lg:mt-[60px]"} PlaceHolder={'Insira seu e-mail'} Type={"email"}/>
            <label className="mt-[15px] lg:mt-[60px] font-lexenddeca color-terciario lg:text-[37px]">Insira seu aniversário</label>
            <Input Style={"w-[80%] outline-none bg-primario p-[15px] lg:p-[55px] rounded-[15px] lg:rounded-[35px] lg:text-[40px] "} PlaceHolder={'Insira sua data de nascimento'} Type={"date"}/>
            <Input Style={"w-[80%] outline-none bg-primario p-[15px] lg:p-[55px] rounded-[15px] lg:rounded-[35px] lg:text-[40px] placeholder:text-[15px] lg:placeholder:text-[45px] placeholder:font-lexenddeca mt-[27px] lg:mt-[60px]"} PlaceHolder={'Crie uma senha'} Type={"password"}/>
            <Input Style={"w-[80%] outline-none bg-primario p-[15px] lg:p-[55px] rounded-[15px] lg:rounded-[35px] lg:text-[40px] placeholder:text-[15px] lg:placeholder:text-[45px] placeholder:font-lexenddeca mt-[27px] lg:mt-[60px]"} PlaceHolder={'Confirme sua senha'} Type={"password"}/>
