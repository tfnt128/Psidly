...
export default function BoxExcluirConta(){
    return(
        <div className="w-[85%] lg:w-[40%] h-[480px] lg:h-[1700px] bg-terciario mt-[30%] lg:mt-[5%]  rounded-[50px] lg:rounded-[100px] flex flex-col items-center">
            ...
            <Input Type={"password"} Style={"w-[80%] h-[40px] lg:h-[150px] bg-primario lg:text-[60px] rounded-[10px] lg:rounded-[50px] mt-[70px] lg:p-10 outline-none p-4"} PlaceHolder={"Digite sua senha"} />
